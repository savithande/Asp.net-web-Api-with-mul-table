...
using RestorentManagementSystem.Models;

namespace RestorentManagementSystem.Controllers
{
    public class OrderItemsController : ApiController
    {
        private RestorentDBEntities db = new RestorentDBEntities();
        ...
        public IHttpActionResult PostOrderItem(OrderItem orderItem)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = orderItem.OederItemId }, orderItem);
        }
        ...
        {
            return db.OrderItems.Count(e => e.OederItemId == id) > 0;
        }
    }
}